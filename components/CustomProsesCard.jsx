    ...
    <View className={`${containerStyles}`}>
      <View className="w-full border border-secondary bg-primary px-4 rounded-lg">
        ...
        <View className="items-center justify-center border border-black-100 py-3 mt-3 rounded-lg">
          <Image source={{ uri: getImageViewUrl(config.storageId, data.imagesampah, config.projectId) }} className="w-16 h-16" />
        ...
        <View className="border border-black-100 py-3 mt-3 px-4 gap-3 mb-3 rounded-lg">
          <Text>
            <Text className="font-bold">Total sampah</Text>: {data.total_sampah || "1"} sampah
          </Text>
          <Text>
            <Text className="font-bold">Sampah akan dijemput pada</Text>: {data.tanggalPenjemputan || "Belum ditentukan"}
          </Text>
          <CustomButton
            title="Lihat Rincian"
          ...
          />
          <Text>
            <Text className="font-bold">No. Antrean</Text>: {data.nomor_antrean || "Belum ada"}
          </Text>
        </View>
      </View>
    </View>
